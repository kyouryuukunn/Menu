...
*line
		...
		@if exp="kag.getBookMarkDate(1 + save.page*save.column*save.line + save.temp_column*save.line + save.temp_line) != ''"
			...
			@image storage=&save.new layer=0 page=fore visible=true left="&save.base_x + save.temp_column * save.width + save.new_x" top="&save.base_y + save.temp_line * save.height +save.new_y" cond="sf.save_new == 1 + save.page*save.column*save.line + save.temp_column*save.line + save.temp_line"
			@nowait
